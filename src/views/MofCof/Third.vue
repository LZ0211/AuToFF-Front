  ...
  <a-spin :spinning="isLoading">
    <div class="third-wrapper">
      ...
      <div class="third-wrapper-content">
        ...
        <!-- 右侧 -->
        <div
          style="display: flex; flex: 1; flex-flow: column; margin-left: 24px"
        >
...
export default {
  ...
  created() {
    ...
    // Promise.all([p4])
    //   .then(([data4]) => {
    //     let chargeData = data4.atoms.map((item, index) => {
    //       return {
    //         key: index.toString(),
    //         id: (index + 1).toString(),
    ...
    //         alpha: item[8],
    //         beta: item[9],
    //         charge: this.atoms[index]["charge"],
    //         noEdit: true,
    //       };
    //     });
  ...
  methods: {
    initChargeParams() {
      ...
      if (this.chargeType === "mof-GMP-qeq") {
        return new Promise((resolve, reject) => {
          request
            .postJson(
              api.GMPqeq,
      ...
      if (this.chargeType === "mof-MEPO-qeq") {
        return new Promise((resolve, reject) => {
          request
            .postJson(
              api.MEPOqeq,
    ...
    initParams() {
      return new Promise((resolve, reject) => {
        console.log("-->this.atomtypeOriginData", this.atomtypeOriginData);
        console.log("-->this.atomtypeTableData", this.atomtypeTableData);
